...
function patchwork_theme_options_init() {
	...
	add_settings_field( 'theme_style', __( 'Theme Style', 'patchwork' ), 'patchwork_settings_field_theme_style', 'theme_options', 'general' );

	add_settings_field( 'custom_css', __( 'Custom CSS', 'vintage-camera' ), 'patchwork_settings_field_custom_css', 'theme_options', 'general' );
...
function patchwork_theme_style() {
	$patchwork_theme_style = array(
		'maude' => array(
			...
			'defaults' => array(
				'default-color' => '63b6b1',
				'default-description-color' => '46433a',
			)
		),
		'babycakes' => array(
			'value' => 'babycakes',
			...
			'defaults' => array(
				'default-color' => 'ef9595',
				'default-description-color' => '774f47',
			)
		),
		'sunny' => array(
			'value' => 'sunny',
			...
			'defaults' => array(
				'default-color' => 'e55f49',
				'default-description-color' => '4c2c24',
			)
		),
	);
...
function patchwork_theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<h2><?php printf( __( '%s Theme Options', 'patchwork' ), wp_get_theme() ); ?></h2>
		<?php settings_errors(); ?>
 ...
 */
function patchwork_admin_layout_styles( $hook_suffix ) {
...
add_action( 'admin_enqueue_scripts', 'patchwork_admin_layout_styles' );
